...
// The framework auto-generates three HTTP endpoints for the workflow:
//   POST /api/workflows/ExpenseReimbursement/run          - Start the workflow
//   GET  /api/workflows/ExpenseReimbursement/status/{id}  - Check status and pending approvals
//   POST /api/workflows/ExpenseReimbursement/respond/{id} - Send approval response to resume

using Microsoft.Agents.AI.Hosting.AzureFunctions;
using Microsoft.Agents.AI.Workflows;
using Microsoft.Azure.Functions.Worker.Builder;
using Microsoft.Extensions.Hosting;
using HumanInTheLoopFunctions;
